...
def test_list_debits_date_filter(swell):
    ...
    date_filtered = swell.debits.list({
...
def test_list_debits_with_return_limit(swell):
    ...
    limit = 1
    response = swell.debits.list({"limit": limit})
...
def test_list_debits_expansion(swell):
    ...
    response = swell.debits.list({"expand": ["parent"]})
...
def test_get_debits_by_giftcard_id(swell, use_keys):
    ...
    id_response = swell.debits.get(first_giftcard_id)
...
def test_get_giftcard_debits_expanded(swell, use_keys):
    ...
    id_response = swell.debits.get(first_giftcard_id, { "expand": ['parent'] })
...
def test_create_giftcard_use(swell, use_keys):
    ...
    response = swell.debits.create(new_giftcard_use)
...
def test_delete_giftcard_use(swell, use_keys):
    ...
    delete_response = swell.debits.delete(first_giftcard_use_id)
